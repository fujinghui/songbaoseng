		...
		<div data-role="page" data-theme="a">
			...
			<div data-role="content">
				<ul data-role="listview" data-inset="true">
					<li data-role="list-divider">趣视频</li>
					<?php 
						...
						for($i = 0; $i < count($list); $i ++)
						{
							$obj = $list[$i];
					?>
						<li><a href="<?php echo $obj->video_link_url;?>" data-ajax="false"><img src="img/<?php echo $obj->video_link_img_src;?>" style="height:100px;width:100px;"><span><?php echo $obj->video_link_context;?></span></a></li>
					<!--
